...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Сброс/Установка пароля') }}</div>
                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div style="margin-top: 20px" class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email"  name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus disabled>
                            </div>
                        </div>
